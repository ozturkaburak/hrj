...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CERTIFICATE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CERTIFICATE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CERTIFICATE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CERTIFICATE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CERTIFICATE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CERTIFICATE actions', async () => {
      const arg = 42666;
