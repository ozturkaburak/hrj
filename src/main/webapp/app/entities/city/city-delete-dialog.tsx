...
export const CityDeleteDialog = () => {
  ...
  const updateSuccess = useAppSelector(state => state.hr.city.updateSuccess);

  const handleClose = () => {
    navigate('/city' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hrApp.city.delete.question">
        <Translate contentKey="hrApp.city.delete.question" interpolate={{ id: cityEntity.id }}>
