...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERASSIGNMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERASSIGNMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERASSIGNMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERASSIGNMENT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERASSIGNMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERASSIGNMENT actions', async () => {
      const arg = 42666;
