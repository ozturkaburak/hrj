...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './upload.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_UPLOAD_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_UPLOAD actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_UPLOAD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_UPLOAD actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_UPLOAD actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_UPLOAD actions', async () => {
      const arg = 42666;
