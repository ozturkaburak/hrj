...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EXPERIENCE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EXPERIENCE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EXPERIENCE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EXPERIENCE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EXPERIENCE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EXPERIENCE actions', async () => {
      const arg = 42666;
