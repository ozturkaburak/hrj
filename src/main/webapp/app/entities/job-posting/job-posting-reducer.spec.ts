...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_JOBPOSTING_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_JOBPOSTING actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_JOBPOSTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_JOBPOSTING actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_JOBPOSTING actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_JOBPOSTING actions', async () => {
      const arg = 42666;
