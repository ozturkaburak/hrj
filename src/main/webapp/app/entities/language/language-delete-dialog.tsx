...
export const LanguageDeleteDialog = () => {
  ...
  const updateSuccess = useAppSelector(state => state.hr.language.updateSuccess);
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hrApp.language.delete.question">
        <Translate contentKey="hrApp.language.delete.question" interpolate={{ id: languageEntity.id }}>
