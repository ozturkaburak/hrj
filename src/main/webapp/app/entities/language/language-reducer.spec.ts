...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './language.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LANGUAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LANGUAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LANGUAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LANGUAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LANGUAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LANGUAGE actions', async () => {
      const arg = 42666;
