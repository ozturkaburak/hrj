...
export const UserProfileDeleteDialog = () => {
  ...
  const updateSuccess = useAppSelector(state => state.hr.userProfile.updateSuccess);
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hrApp.userProfile.delete.question">
        <Translate contentKey="hrApp.userProfile.delete.question" interpolate={{ id: userProfileEntity.id }}>
