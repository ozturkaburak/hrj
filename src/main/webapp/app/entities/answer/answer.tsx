...
export const Answer = () => {
  ...
  const answerList = useAppSelector(state => state.hr.answer.entities);
  const loading = useAppSelector(state => state.hr.answer.loading);
  const totalItems = useAppSelector(state => state.hr.answer.totalItems);
  ...
  return (
    <div>
      <h2 id="answer-heading" data-cy="AnswerHeading">
        <Translate contentKey="hrApp.answer.home.title">Answers</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hrApp.answer.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/answer/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hrApp.answer.home.createLabel">Create new Answer</Translate>
          </Link>
        </div>
      </h2>
        ...
        {answerList && answerList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="hrApp.answer.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th>
                  <Translate contentKey="hrApp.answer.question">Question</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="hrApp.answer.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {answerList.map((answer, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{answer.user ? answer.user.id : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hrApp.answer.home.notFound">No Answers found</Translate>
            </div>
          )
        )}
      </div>
