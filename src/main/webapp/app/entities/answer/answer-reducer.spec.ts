...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './answer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ANSWER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ANSWER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ANSWER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ANSWER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ANSWER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ANSWER actions', async () => {
      const arg = 42666;
