...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './company.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPANY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPANY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPANY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_COMPANY actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPANY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPANY actions', async () => {
      const arg = 42666;
