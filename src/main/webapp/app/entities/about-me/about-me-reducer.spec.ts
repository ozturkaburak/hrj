...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './about-me.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ABOUTME_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ABOUTME actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ABOUTME actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_ABOUTME actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_ABOUTME actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ABOUTME actions', async () => {
      const arg = 42666;
