...
export const CountryDeleteDialog = () => {
  ...
  const updateSuccess = useAppSelector(state => state.hr.country.updateSuccess);

  const handleClose = () => {
    navigate('/country' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hrApp.country.delete.question">
        <Translate contentKey="hrApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
