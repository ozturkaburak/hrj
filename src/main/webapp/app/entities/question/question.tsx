...
export const Question = () => {
  ...
  const questionList = useAppSelector(state => state.hr.question.entities);
  const loading = useAppSelector(state => state.hr.question.loading);
  const totalItems = useAppSelector(state => state.hr.question.totalItems);
  ...
  return (
    <div>
      <h2 id="question-heading" data-cy="QuestionHeading">
        <Translate contentKey="hrApp.question.home.title">Questions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="hrApp.question.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/question/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="hrApp.question.home.createLabel">Create new Question</Translate>
          </Link>
        </div>
      </h2>
        ...
        {questionList && questionList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="hrApp.question.id">ID</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                ...
                <th className="hand" onClick={sort('type')}>
                  <Translate contentKey="hrApp.question.type">Type</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('type')} />
                </th>
            ...
            <tbody>
              {questionList.map((question, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    <Translate contentKey={`hrApp.QuestionType.${question.type}`} />
                  </td>
                  <td>{question.correctAnswer}</td>
                  <td>{question.createdAt ? <TextFormat type="date" value={question.createdAt} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{question.updatedAt ? <TextFormat type="date" value={question.updatedAt} format={APP_DATE_FORMAT} /> : null}</td>
                  <td>{question.deletedAt ? <TextFormat type="date" value={question.deletedAt} format={APP_DATE_FORMAT} /> : null}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="hrApp.question.home.notFound">No Questions found</Translate>
            </div>
          )
        )}
      </div>
