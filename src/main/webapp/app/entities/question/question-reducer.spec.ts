...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './question.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_QUESTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_QUESTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_QUESTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_QUESTION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_QUESTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_QUESTION actions', async () => {
      const arg = 42666;
