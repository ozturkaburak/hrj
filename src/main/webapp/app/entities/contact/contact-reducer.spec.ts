...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './contact.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTACT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CONTACT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CONTACT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CONTACT actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CONTACT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CONTACT actions', async () => {
      const arg = 42666;
