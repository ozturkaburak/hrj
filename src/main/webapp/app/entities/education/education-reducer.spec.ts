...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './education.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EDUCATION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_EDUCATION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_EDUCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_EDUCATION actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_EDUCATION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_EDUCATION actions', async () => {
      const arg = 42666;
