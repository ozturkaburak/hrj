...
export const ResumeDeleteDialog = () => {
  ...
  const updateSuccess = useAppSelector(state => state.hr.resume.updateSuccess);

  const handleClose = () => {
    navigate('/resume' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="hrApp.resume.delete.question">
        <Translate contentKey="hrApp.resume.delete.question" interpolate={{ id: resumeEntity.id }}>
