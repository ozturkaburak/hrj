...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './resume.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RESUME_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RESUME actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RESUME actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_RESUME actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_RESUME actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RESUME actions', async () => {
      const arg = 42666;
