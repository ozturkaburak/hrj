...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERLANGUAGE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_USERLANGUAGE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_USERLANGUAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_USERLANGUAGE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_USERLANGUAGE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_USERLANGUAGE actions', async () => {
      const arg = 42666;
