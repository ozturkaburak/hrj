...
import com.ab.hr.service.CompanyService;
...
/**
 * REST controller for managing {@link com.ab.hr.domain.Company}.
 */
@RestController
...
public class CompanyResource {
    ...
    public Mono<ResponseEntity<List<CompanyDTO>>> getAllCompanies(
        ...
        if ("jobposting-is-null".equals(filter)) {
            log.debug("REST request to get all Companys where jobPosting is null");
            return companyService.findAllWhereJobPostingIsNull().collectList().map(ResponseEntity::ok);
        }

        if ("experience-is-null".equals(filter)) {
            log.debug("REST request to get all Companys where experience is null");
            return companyService.findAllWhereExperienceIsNull().collectList().map(ResponseEntity::ok);
        }
     ...
     */
    @GetMapping("/{id}")
    public Mono<ResponseEntity<CompanyDTO>> getCompany(@PathVariable("id") Long id) {
     ...
     */
    @DeleteMapping("/{id}")
    public Mono<ResponseEntity<Void>> deleteCompany(@PathVariable("id") Long id) {
