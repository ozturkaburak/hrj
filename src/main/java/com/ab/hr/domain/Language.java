...
public class Language implements Serializable {
    ...
    public Language createdAt(Instant createdAt) {
    ...
    public Language updatedAt(Instant updatedAt) {
    ...
    public Language deletedAt(Instant deletedAt) {
    ...
    public void setUserLanguage(UserLanguage userLanguage) {
        if (this.userLanguage != null) {
            this.userLanguage.setLanguage(null);
        }
    ...
    public Language userLanguage(UserLanguage userLanguage) {
