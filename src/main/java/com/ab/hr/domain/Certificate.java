...
public class Certificate implements Serializable {
    ...
    public Certificate createdAt(Instant createdAt) {
    ...
    public Certificate updatedAt(Instant updatedAt) {
    ...
    public Certificate deletedAt(Instant deletedAt) {
    ...
    public Certificate userProfile(UserProfile userProfile) {
